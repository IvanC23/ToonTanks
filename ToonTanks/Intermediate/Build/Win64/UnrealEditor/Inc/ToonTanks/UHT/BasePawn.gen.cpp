...
struct Z_Construct_UClass_ABasePawn_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BaseMesh_MetaData[] = {
		...
		{ "Comment", "// Forward declaration, I'm telling the compiler that this class exists and I will define it later to not include it in the headers, hence in the file\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "BasePawn.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Forward declaration, I'm telling the compiler that this class exists and I will define it later to not include it in the headers, hence in the file" },
#endif
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_crusc_Documents_GitHub_ToonTanks_ToonTanks_Source_ToonTanks_BasePawn_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABasePawn, ABasePawn::StaticClass, TEXT("ABasePawn"), &Z_Registration_Info_UClass_ABasePawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABasePawn), 2094490411U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_crusc_Documents_GitHub_ToonTanks_ToonTanks_Source_ToonTanks_BasePawn_h_2691882314(TEXT("/Script/ToonTanks"),
	Z_CompiledInDeferFile_FID_Users_crusc_Documents_GitHub_ToonTanks_ToonTanks_Source_ToonTanks_BasePawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_crusc_Documents_GitHub_ToonTanks_ToonTanks_Source_ToonTanks_BasePawn_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
